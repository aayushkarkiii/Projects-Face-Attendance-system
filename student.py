...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","CIVIL","Computer","ELECTRICAL","MECHANICAL","IT","ARCHITECTURAL")
        dep_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2017-21","2018-22","2019-23","2020-24","2021-2025")
