...
class Train:
    ...
    def __init__(self, root):
        ...
        # background image
        bg1 = Image.open(r"S:\Project-II\Images_GUI\t_bg1.jpg")
        ...
        # -------------------------------------------------------------------------------------------------------------------
        # Training button 1
        std_img_btn = Image.open(r"S:\Project-II\Images_GUI\t_btn1.png")
        ...
        std_b1_1 = Button(bg_img, command=self.train_classifier, text="Train Dataset", cursor="hand2", font=("tahoma", 15, "bold"),
