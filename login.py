...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"S:\Project-II\Images_GUI\loginBg1.jpg")
        ...
        img1=Image.open(r"S:\Project-II\Images_GUI\log1.png")
        ...
        loginbtn=Button(frame1,command=self.reg,text="Create",font=("times new roman",12,"bold"),bd=2,relief=RIDGE,fg="white",bg="#002B53",activeforeground="orange",activebackground="#002B53")
        loginbtn.place(x=50,y=370,width=70,height=20)


        # Creating Button Forget
        loginbtn=Button(frame1,command=self.forget_pwd,text="Forget",font=("times new roman",10,"bold"),bd=2,relief=RIDGE,fg="white",bg="#002B53",activeforeground="orange",activebackground="#002B53")
        loginbtn.place(x=150,y=370,width=50,height=20)
        # loginbtn=Button(frame1,command=self.forgot_pwd,text="Forgot",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="white",bg="#002B53",activeforeground="orange",activebackground="#002B53")
...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"S:\Project-II\Images_GUI\bg3.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"S:\Project-II\Images_GUI\std1.jpg")
        ...
        det_img_btn=Image.open(r"S:\Project-II\Images_GUI\det1.jpg")
        det_img_btn=det_img_btn.resize((180,180),Image.ANTIALIAS)
        self.det_img1=ImageTk.PhotoImage(det_img_btn)

        det_b1 = Button(bg_img,command=self.face_rec,image=self.det_img1,cursor="hand2",)
        det_b1.place(x=480,y=270,width=180,height=180)

        det_b1_1 = Button(bg_img,command=self.face_rec,text="Face Detector",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=480,y=471,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"S:\Project-II\Images_GUI\att.jpg")
        att_img_btn=att_img_btn.resize((200,180),Image.ANTIALIAS)
        self.att_img1=ImageTk.PhotoImage(att_img_btn)

        att_b1 = Button(bg_img,command=self.attendance_pannel,image=self.att_img1,cursor="hand2",)
        att_b1.place(x=700,y=270,width=180,height=180)
        ...
        att_b1_1.place(x=700,y=471,width=180,height=45)
         ...
         # Train   button 5
        tra_img_btn=Image.open(r"S:\Project-II\Images_GUI\tra1.jpg")
        ...
        # Developers   button 7
        dev_img_btn=Image.open(r"S:\Project-II\Images_GUI\dev.jpg")
        dev_img_btn=dev_img_btn.resize((18,18),Image.ANTIALIAS)
        self.dev_img1=ImageTk.PhotoImage(dev_img_btn)

        dev_b1 = Button(bg_img,command=self.developr,image=self.dev_img1,cursor="hand2",)
        dev_b1.place(x=40,y=50,width=18,height=18)

        dev_b1_1 = Button(bg_img,command=self.developr,text="Developers",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        dev_b1_1.place(x=900,y=590,width=180,height=30)

        # exit   button 8
        exi_img_btn=Image.open(r"S:\Project-II\Images_GUI\exi.jpg")
        exi_img_btn=exi_img_btn.resize((10,10),Image.ANTIALIAS)
        self.exi_img1=ImageTk.PhotoImage(exi_img_btn)

        exi_b1 = Button(bg_img,image=self.exi_img1,cursor="hand2",)
        exi_b1.place(x=40,y=50,width=10,height=10)

        exi_b1_1 = Button(bg_img,text="Exit",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        exi_b1_1.place(x=1100,y=590,width=180,height=30)
